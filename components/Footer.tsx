...
const SocialIcon: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" className="text-neutral-text transition-colors hover:text-gold">
    {children}
  </a>
);
...
const Footer: React.FC = () => {
  return (
    <footer className="bg-black/50 border-t border-gold/10 py-12">
      <div className="container mx-auto px-6 text-center">
        <h3 className="font-serif text-3xl text-white mb-4">Let's Connect</h3>
        <p className="max-w-md mx-auto mb-8">
          Interested in collaborating on a project? I'm always open to discussing new ideas and opportunities.
        </p>
        <a 
          href="mailto:simran112025@gmail.com" 
          className="inline-block bg-transparent border-2 border-gold text-gold font-bold py-3 px-8 rounded-full transition-all duration-300 hover:bg-gold hover:text-background"
        >
          simran112025@gmail.com
        </a>
        <div className="flex justify-center space-x-6 mt-10">
          <SocialIcon href="https://github.com/harsimranjit-passion">
          ...
          <SocialIcon href="https://www.linkedin.com/in/harsimranjit/">
        ...
        <p className="mt-10 text-sm text-neutral-500">&copy; {new Date().getFullYear()} Digital Craftsman. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
